...
class MyViewController : UIViewController {
    ...
    private func getRec() -> UIBezierPath {
        let rect = CGRect(x: 10, y: 10, width: 200, height: 100)
        let rectPath = UIBezierPath(roundedRect: rect, byRoundingCorners: [.bottomRight, .topLeft], cornerRadii: CGSize(width: 30, height: 0))
